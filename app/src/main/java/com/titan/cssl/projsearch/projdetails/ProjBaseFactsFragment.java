...
import com.titan.cssl.databinding.FragBaseFactsBinding;
...
public class ProjBaseFactsFragment extends Fragment {

    private Context mContext;
    private FragBaseFactsBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.frag_base_facts,container,false);
